...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--outf', default='/cluster/project0/gans/ganomaly/augmented/100d/', help='folder to output images and model checkpoints')
        ...
        self.parser.add_argument('--perc_outlier', type=float, default=None, help='Contamination in test set')
